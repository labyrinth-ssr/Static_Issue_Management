    ...
    public static void run() throws Exception {
        ...
        while(true) {
            ...
            if(str.startsWith("latest_defect")){
                ...
                queryMappingByTime.getCountInByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByTime.getGCountInTypeByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByTime.getListInByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("\n");
                queryMappingByTime.getCountDoneByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByTime.getCountDoneInTypeByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByTime.getListDoneByCommit_time(begin_time,end_time,REPO_PATH);
                ...
                String begin_time = s[0];
                String end_time = getString2(s);
                queryMappingByTime.getAnalysisCountByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByTime.getAnalysisCountByTypeByCommit_time(begin_time,end_time,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByTime.getAnalysisCountByType_idByCommit_time(begin_time,end_time,REPO_PATH);
            }else if(str.startsWith("duration")){
                str = str.substring(8).trim();
                queryMappingByTime.getDefectListMoreThanDuration(str,REPO_PATH);
            }else if(str.startsWith("devs")){
                str = str.substring(4).trim();
                if(str.equals("")) continue;
                queryMappingByDev.getDevCountByDevs(str,REPO_PATH);
                System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
                queryMappingByDev.getDevTypeCountByDevs(str,REPO_PATH);
            }
        }
    }
